<template>
  ...
  <section id="s2" class="fade flex flex-col justify-center items-center w-full relative opacity-0">
    <div class="mt-20 flex h-20 text-gray-100 font-mono text-2xl relative">
