import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'vue';
import { k as klona, i as defuFn, e as createError$1, j as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch$1, o as baseURL, q as createHooks, r as executeAsync, t as toRouteMatcher, v as createRouter$1, x as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CSH0HLWl.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-DKWa08Cm.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CJmnHzi9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-PPX8anHS.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry$1 as default, useAppConfig as e, asyncDataDefaults as f, createError as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
